...
export const INITIAL_PROJECTS: Project[] = [
  // 1. ShadowPaw (Direct Game Link)
  {
    ...
    liveDemoUrl: 'https://nrnworld.one/ShadowPaw/',
    featured: true,
    rating: 4.98,
    downloadsCount: 0,
    starsCount: 1,
    ...
    downloadOptions: [
      {
        ...
        fileType: 'zip',
        size: '178.7 MB',
        filename: 'Doggy-Player-Setup-1.1.71.zip',
        directUrl: 'https://github.com/nRn-World/Doggy-Player/releases/download/v1.1.71/Doggy-Player-Setup-1.1.71.zip',
        githubReleaseUrl: 'https://github.com/nRn-World/Doggy-Player/releases/download/v1.1.71/Doggy-Player-Setup-1.1.71.zip',
    ...
    changelog: [
      {
        ...
        isCurrent: true,
        items: [
          'Release v1.1.71 with updated Windows installer and portable ZIP',
  ...
  // 6. TheSilentRoom1986 (Direct Game Link)
  {
    ...
    platformBadge: 'WEB',
    projectType: 'web_game',
    liveDemoUrl: 'https://nrnworld.one/TheSilentRoom1986/',
    featured: true,
    rating: 4.95,
    downloadsCount: 0,
    starsCount: 1,
  ...
  // 7. NeonPathPuzzle (Direct Game Link)
  {
    ...
    platformBadge: 'WEB',
    projectType: 'web_game',
    liveDemoUrl: 'https://nrnworld.one/NeonPathPuzzle/',
    featured: false,
    rating: 4.88,
    downloadsCount: 0,
    starsCount: 1,
  ...
  // 8. DoneTogether (Web App + Android APK)
  {
    ...
    platformBadge: 'APK',
    projectType: 'web_app',
    liveDemoUrl: 'https://nrnworld.one/DoneTogether/',
    featured: true,
    rating: 4.90,
    downloadsCount: 0,
    starsCount: 1,
  ...
  // 11. SiteScannerPro (Direct Web App)
  {
    ...
    platformBadge: 'WEB',
    projectType: 'web_app',
    liveDemoUrl: 'https://nrnworld.one/SiteScannerPro/',
    featured: true,
    rating: 4.93,
    downloadsCount: 0,
    starsCount: 1,
  ...
  // 12. GLOBAL_EMERGENCY (Direct Web App)
  {
    ...
    platformBadge: 'WEB',
    projectType: 'web_app',
    liveDemoUrl: 'https://nrnworld.one/GLOBAL_EMERGENCY/',
    featured: false,
    rating: 4.94,
    downloadsCount: 0,
    starsCount: 1,
  ...
  // 18. ParkeraiSthlm (Stockholm Parking Map)
  {
    ...
    platformBadge: 'WEB',
    projectType: 'web_app',
    liveDemoUrl: 'https://nrnworld.one/ParkeraiSthlm/',
    featured: false,
    rating: 4.89,
    downloadsCount: 0,
    starsCount: 0,
